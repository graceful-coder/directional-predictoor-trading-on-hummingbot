...
class RSI(DirectionalStrategyBase):
    ...
    candles = [CandlesFactory.get_candle(CandlesConfig(connector="binance_perpetual", trading_pair="CRV-USDT", interval="5m", max_records=1000))]
